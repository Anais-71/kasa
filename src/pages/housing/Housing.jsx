                ...
                <div key={index}>
                    ...
                    <div className="housing__tags">
                        {item.tags && item.tags.map((tag, i) => (
                            <div key={i} className="housing__tags--tag">{tag}</div>
                        ))}
                    </div>
                    <div className="housing__rating">
                        {[...Array(5)].map((star, i) => {
                            ...
                            return (
                                <FaStar key={i} color={ratingValue <= item.rating ? "red" : "#E3E3E3"} size={24} />
                            );
                        })}
                    </div>
                    <div className='housing__dropdowns'>
                    <Dropdown title="Description" items={item.description ? [item.description] : []} />
